                      ...
                      {props.plan1Feature1 ?? (
                        <Fragment>
                          <span className="pricing14-text200">
                            Unlimited access to legal chatbot
                          </span>
                        </Fragment>
                      )}
                    </span>
            ...
            <div className="pricing14-column2 thq-card">
              <div className="pricing14-price12">
                <div className="pricing14-price13">
                  ...
                  <h3 className="pricing14-text115 thq-heading-3">
                    {props.plan2Price ?? (
                      <Fragment>
                        <span className="pricing14-text188">$49.99/month</span>
                      </Fragment>
                    )}
                  </h3>
                  <p className="thq-body-large">
                    {props.plan2Yearly ?? (
                      <Fragment>
                        <span className="pricing14-text168">$499.99/year</span>
                      </Fragment>
                    )}
                  </p>
                </div>
              ...
              <button className="pricing14-button15 thq-button-animated thq-button-filled">
                <span className="thq-body-small">
                  {props.plan2Action ?? (
                    <Fragment>
                      <span className="pricing14-text170">Subscribe Now</span>
                    </Fragment>
                  )}
                </span>
              </button>
            ...
            <div className="pricing14-column3 thq-card">
              <div className="pricing14-price14">
                <div className="pricing14-price15">
                  ...
                  <h3 className="pricing14-text123 thq-heading-3">
                    {props.plan3Price ?? (
                      <Fragment>
                        <span className="pricing14-text155">$79.99/month</span>
                      </Fragment>
                    )}
                  </h3>
                  <p className="thq-body-large">
                    {props.plan3Yearly ?? (
                      <Fragment>
                        <span className="pricing14-text194">$799.99/year</span>
                      </Fragment>
                    )}
                  </p>
                </div>
              ...
              <button className="pricing14-button16 thq-button-animated thq-button-filled">
                <span className="thq-body-small">
                  {props.plan3Action ?? (
                    <Fragment>
                      <span className="pricing14-text156">Subscribe Now</span>
                    </Fragment>
                  )}
                </span>
              </button>
              ...
              <div className="pricing14-price16">
                <div className="pricing14-price17">
                  ...
                  <h3 className="pricing14-text132 thq-heading-3">
                    {props.plan1Price1 ?? (
                      <Fragment>
                        <span className="pricing14-text173">$299.99/year</span>
                      </Fragment>
                    )}
                  </h3>
                  <span className="thq-body-large">
                    {props.plan1Yearly1 ?? (
                      <Fragment>
                        <span className="pricing14-text192">$299.99/year</span>
                      </Fragment>
                    )}
                  </span>
                </div>
              ...
              <div className="pricing14-price18">
                <div className="pricing14-price19">
                  ...
                  <h3 className="pricing14-text139 thq-heading-3">
                    {props.plan2Price1 ?? (
                      <Fragment>
                        <span className="pricing14-text193">$499.99/year</span>
                      </Fragment>
                    )}
                  </h3>
                  <span className="thq-body-large">
                    {props.plan2Yearly1 ?? (
                      <Fragment>
                        <span className="pricing14-text187">$499.99/year</span>
                      </Fragment>
                    )}
                  </span>
                </div>
              ...
              <div className="pricing14-price20">
                <div className="pricing14-price21">
                  ...
                  <h3 className="pricing14-text147 thq-heading-3">
                    {props.plan3Price1 ?? (
                      <Fragment>
                        <span className="pricing14-text196">$799.99/year</span>
                      </Fragment>
                    )}
                  </h3>
                  <span className="thq-body-large">
                    {props.plan3Yearly1 ?? (
                      <Fragment>
                        <span className="pricing14-text189">$799.99/year</span>
                      </Fragment>
                    )}
                  </span>
                </div>
                      ...
                      {props.plan3Feature21 ?? (
                        <Fragment>
                          <span className="pricing14-text166">
                            Access to top law firms network
                          </span>
                        </Fragment>
                      )}
                    </span>
